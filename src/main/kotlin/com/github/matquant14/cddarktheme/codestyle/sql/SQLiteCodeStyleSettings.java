...
public class SQLiteCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public SQLiteCodeStyleSettings(CodeStyleSettings settings) {
        super("SQLiteCodeStyleSettings", settings);
    }
}
