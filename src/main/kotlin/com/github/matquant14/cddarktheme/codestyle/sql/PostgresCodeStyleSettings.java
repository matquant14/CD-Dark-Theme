...
public class PostgresCodeStyleSettings extends CustomCodeStyleSettings {
    public Boolean USE_GENERAL_STYLE = true;
    ...
    public PostgresCodeStyleSettings(CodeStyleSettings settings) {
        super("PostgresCodeStyleSettings", settings);
    }
}
