...
public class DerbyCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public DerbyCodeStyleSettings(CodeStyleSettings settings) {
        super("DerbyCodeStyleSettings", settings);
    }
}