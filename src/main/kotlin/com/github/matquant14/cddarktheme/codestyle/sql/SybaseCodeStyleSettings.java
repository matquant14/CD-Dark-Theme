...
public class SybaseCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public SybaseCodeStyleSettings(CodeStyleSettings settings) {
        super("SybaseCodeStyleSettings", settings);
    }
}
