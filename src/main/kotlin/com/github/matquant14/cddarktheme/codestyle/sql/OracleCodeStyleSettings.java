...
public class OracleCodeStyleSettings extends CustomCodeStyleSettings {
    ...
    public OracleCodeStyleSettings(CodeStyleSettings settings) {
        super("OracleCodeStyleSettings", settings);
    }
}
